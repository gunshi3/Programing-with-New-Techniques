...
//        setContentView(R.layout.activity_register);
        ...
        //取消注册按钮响应事件
        Button button = findViewById(R.id.bt_cancel_register);
        ...
        setOnFocusChangeErrMsg(registerBinding.etTelephone, "phone", "用户名格式不正确");
        setOnFocusChangeErrMsg(registerBinding.etPassword, "password", "密码6-12位，只允许包含英文字母、数字和_");
    ...
    private void setOnClickListener() {
        ...
        registerBinding.btCancelRegister.setOnClickListener(this);
    }
...
//                            showToastInThread(RegisterActivity.this, "验证码：" + otpCode);
    ...
    private void asyncRegisterWithXHttp2(final String telephone,
        ...
        if (TextUtils.isEmpty(telephone)
            ...
            Toast.makeText(RegisterActivity.this, "存在必要输入为空，注册失败", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        XHttp.post(NetConstant.getRegisterURL())
                ...
                .execute(new SimpleCallBack<Object>() {
                    ...
                    public void onSuccess(Object data) throws Throwable {
                        ...
                        if (editor.commit()) {
                            Intent intentToMain = new Intent(RegisterActivity.this, InfoActivity.class);
                            intentToMain.putExtra("userName", telephone);
                        ...
                        public void onResponse(Call call, Response response) throws IOException {
                            ...
                            if (responseStr.contains("200")) {
                                ...
                                if (getResponseStatus(responseBodyJSONObject).equals("success")) {
                                    ...
                                    if (editor.commit()) {
                                        Intent it_register_to_main = new Intent(RegisterActivity.this, InfoActivity.class);
