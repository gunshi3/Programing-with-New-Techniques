...
//        setContentView(R.layout.activity_login);
        ...
        /*
            ...
            第三个参数：输入不合法时提示信息
         */
        setOnFocusChangeErrMsg(loginBinding.etAccount, "phone", "用户名格式不正确");
        ...
        XHttp.post(NetConstant.getLoginURL())
                ...
                .execute(new SimpleCallBack<Object>() {
                    ...
                    public void onSuccess(Object obj) throws Throwable {
                        ...
                        if (editor.commit()) {
                            Intent it_login_to_main = new Intent(LoginActivity.this, InfoActivity.class);
                            it_login_to_main.putExtra("userName", telephone);
