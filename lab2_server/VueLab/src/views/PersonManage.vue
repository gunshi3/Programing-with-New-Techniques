<template>
  <div>
    <el-table :data="tableData" border style>
      <el-table-column prop="username" label="用户名" width="217" align="center"></el-table-column>
      <el-table-column prop="name" label="姓名" width="220" align="center"></el-table-column>
      <el-table-column prop="age" label="年龄" width="230" align="center"></el-table-column>
